...
//    private final GoogleApiClient googleApiClient;
    ...
    public PlaceAutocompleteAdapter( Context context, GeoDataClient geoDataClient,
                                    LatLngBounds bounds, AutocompleteFilter filter, GoogleApiClient googleApiClient) {
...
//
            ...
            if (!status.isSuccess()) {
                ...
                Log.e(TAG, "Error getting autocomple prediction api call: " + status.toString());
...
//
//    private View autocompletePredictions(){
//    }
